...
dialog.add("?", spr_empty, "The engineer seems heavily frustrated with you. Stupid robot..", Slide1)
...
dialog.add("", spr_empty, "Angrily, you get tossed into the dumpster, left to be gone and forgotten about. Not like the engineer cared.. You were just another failed test subject to him after all.", Slide2)
...
dialog.add("!", spr_Rando2, "A young woman happened to walk by later that exact same day, a glistening robot arm sticking out of a dumpster caught both her eye and her attention.", Slide3)
