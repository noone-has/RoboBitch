...
dialog.add("Dennis",spr_DennisPortrait, "Oh sweet, a robot? Since when do we have those running around at school?!") 
dialog.add("Marla", spr_MarlaPortrait, "No idea, actually. They look cool though.")
dialog.add("Marla", spr_MarlaPortrait, "Say, robot, would you like a hit of this cigarette?")
...
dialog_SmokingNo.add("Marla", spr_MarlaPortrait, "By the way, I am Marla, and this is Dennis. What is your name?")
...
dialog_SmokingNo.add("Dennis", spr_DennisPortrait, "If you ever need our help, don’t be afraid to reach out to us.")
