...
dialog.add(spr_emo1Portrait, "Do you want a hit?") //maria/deniz 
dialog.add(spr_Shock, "Isn't that tabacco?")
dialog.add(spr_emo2Portrait, "Yeah, it is.") //maria/deniz
dialog.add(spr_emo2Portrait, "You want a hit or not?")
...
dialog_SmokingNo.add(spr_emo1Portrait, "Okay dork.") //maria/deniz
